...
The Azure IoT team is currently (Nov 2019) moving away from recommending the solution accelerators as a road to production solutions.

[Security for Internet of Things (IoT) from the ground up](https://docs.microsoft.com/en-us/azure/iot-fundamentals/iot-security-ground-up)
