...
![Azure IoT Edge Device Runtime](../../Linked_Image_Files/M06_L01_IoTEdgeRuntime-introduction.png)
...
(MCB) this is probably an issue in the original doc source but we have multiple edge and on-premises solutions - Stack Edge, Stack, IoT Edge - some high level comparison ("why each one would be used") would be very helpful.