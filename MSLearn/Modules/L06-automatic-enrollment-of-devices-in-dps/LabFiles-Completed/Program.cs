...
namespace X509CertificateSimulatedDevice
{
    class Program
    {
        ...
        private const string GlobalDeviceEndpoint = "global.azure-devices-provisioning.net"; // "<DPS-Global-Device-Endpoint>";

        // Azure Device Provisioning Service (DPS) ID Scope
        private static string dpsIdScope = "0ne0009A44C"; // "<DPS-ID-Scope>";

        // Certificate (PFX) File Name
        private static string s_certificateFileName = "new-device.cert.pfx"; // "<Certificate-PFX-Filename>";

        // Certificate (PFX) Password
        private static string s_certificatePassword = "1234"; // "<Certificate-Password>";
